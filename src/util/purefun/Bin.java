...
class Bin<T extends Comparable<? super T>, U> extends SizeBalancedTree<T, U>
{
  ...
  public SizeBalancedTree<T, U> delete (T t)
    {
      ...
      else if (i > 0) return Bin.balance (key, value, left, right.delete (t));
  ...
  public Association<T, U> union (Association<T, U> other)
    {
      ...
      return hedgeUnionL (new ConstantUnary (-1), new ConstantUnary (1), this,
                          (SizeBalancedTree<T, U>) other);
    }
  ...
  static private <T extends Comparable<? super T>, U> SizeBalancedTree<T, U> singleR (
                                                                                      ...
                                                                                      SizeBalancedTree<T, U> r)
    {
      return new Bin<T, U> (l.key, l.value, l.left, new Bin<T, U> (k, v,
                                                                   l.right, r));
    }
  ...
  static private <T extends Comparable<? super T>, U> SizeBalancedTree<T, U> doubleL (
                                                                                      ...
                                                                                      Bin<T, U> r)
    {
      ...
      return new Bin<T, U> (rl.key, rl.value, new Bin<T, U> (k, v, l, rl.left),
  ...
  static private <T extends Comparable<? super T>, U> SizeBalancedTree<T, U> doubleR (
                                                                                      ...
                                                                                      SizeBalancedTree<T, U> r)
    {
      ...
      return new Bin<T, U> (lr.key, lr.value, new Bin<T, U> (l.key, l.value,
                                                             l.left, lr.left),
  ...
  static private <T extends Comparable<? super T>, U> SizeBalancedTree<T, U> hedgeUnionL (
                                                                                          ...
                                                                                          SizeBalancedTree<T, U> t2)
    {
      ...
      UnaryFunctor<T, Integer> cmpx = new UnaryFunctor<T, Integer> ()
        {
          @Override
          public Integer fn (T arg)
            {
      ...
      if (left.isNull ())
      ...
      else
        {
          ...
          if (SizeBalancedTree.DELTA * l.size <= r.size)
            ...
            return balance (l.key, l.value, l.left, join (key, value, l.right,
                                                          r));
          else
            return new Bin<T, U> (key, value, left, right);
        }
    }
  ...
  protected Triple<T, U, SizeBalancedTree<T, U>> deleteFindMax ()
    {
      ...
      return Triple.make (t.first, t.second,
                          balance (key, value, left, t.third));
    }
  ...
  public String toString ()
    {
      return String.format ("Bin (%d, %s, %s, %s, %s)", size, key, value, left,
                            right);
    }
}
