...
public class Table<NT,T,V extends List<?>> implements Iterable<Triple<NT, T, Pair<SemanticPredicate, V>>>
{
  ...
  public List<Triple<NT,T,Pair<SemanticPredicate,V>>> getLines ()
    {
      List<Triple<NT,T,Pair<SemanticPredicate,V>>> result = new ArrayList<Triple<NT,T,Pair<SemanticPredicate,V>>> ();
