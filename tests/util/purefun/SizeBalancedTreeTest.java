...
public class SizeBalancedTreeTest
{
  ...
  public void sequenceInsertion ()
    {
      ...
      assertTrue (largeSet.isMember (4));
      assertEquals ("foo", largeSet.lookup (4));
      assertTrue (largeSet.isMember (-5));
      assertEquals ("bar", largeSet.lookup (-5));
      assertTrue (largeSet.isMember (17));
      assertEquals ("quux", largeSet.lookup (17));
      ...
      assertEquals ("bar", largeSet.lookup (-5));
      assertTrue (largeSet.isMember (17));
      assertEquals ("b", largeSet.lookup (17));
      assertTrue (largeSet.isMember (50));
      assertEquals ("baz", largeSet.lookup (50));
      assertTrue (largeSet.isMember (60));
      assertEquals ("quux", largeSet.lookup (60));
      assertTrue (largeSet.isMember (1032));
      assertEquals ("quubu", largeSet.lookup (1032));
  ...
  private Association<Integer, String> makeVeryLargeSet ()
    {
      return set.insert (L.ist (Pair.make (4, "foo"), Pair.make (-5, "bar"),
                                Pair.make (17, "quux"), Pair.make (50, "baz"),
                                Pair.make (60, "quux"), Pair.make (17, "b"),
                                Pair.make (1032, "quubu")));
    }

  public void replacement ()
    {
      SizeBalancedTree<Integer, String> s =
          set.insert (4, "foo").insert (4, "bar");
      assertTrue (s.isMember (4));
  ...
  public void union ()
    {
      ...
      Association<Integer, String> bigSet =
          largeSet.union (set.insert (Pair.make (50, "baz"),
                                      Pair.make (60, "quux"), Pair.make (17,
                                                                         "b"),
                                      Pair.make (1032, "quubu")));
      ...
      assertEquals (6, bigSet.size ()); // not seven, because two values with
      // key of 17.
    }
  ...
  private Association<Integer, String> makeLargeSet ()
    {
      return set.insert (Pair.make (4, "foo"), Pair.make (-5, "bar"),
                         Pair.make (17, "quux"));
    }
  ...
  public void deletions ()
    {
      ...
      Pair<String, Association<Integer, String>> pair =
          bigSet.lookupAndDelete (50);
  ...
  public void adjusting ()
    {
      Association<Integer, String> bigSet = makeVeryLargeSet ();
      Association<Integer, String> adjusted =
          bigSet.adjust (new UnaryFunctor<String, String> ()
            {
              @Override
              public String fn (String arg)
                {
                  return arg + " appended";
                }
            }, 50);
