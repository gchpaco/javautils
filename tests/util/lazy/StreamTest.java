...
public class StreamTest
{
  ...
  static class Integers extends Generator<Stream<Integer>>
  {
    int current;
    ...
    @Override
    public Stream<Integer> gen ()
      {
        return Stream.cons (current, new Integers (current + 1));
      }

    static Stream<Integer> integers = new Integers (0).fn ();
  }
  ...
  static class Fibonacci extends Generator<Stream<Integer>>
  {
    int last, current;

    Fibonacci (int i, int j)
      {
        last = i;
        current = j;
      }
    ...
    static Stream<Integer> fibonacci = new Fibonacci (1, 0).fn ();
  }
